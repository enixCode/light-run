...
|----------|---------|---------|
| `LIGHT_RUN_TOKEN` | (none) | Bearer token. Unset = open server with a startup warning. CLI-only. |
| `LIGHT_RUN_PORT` | `8080` | Listen port. CLI-only. |
| `LIGHT_RUN_HOST` | `0.0.0.0` | Listen host. CLI-only. |
